...
| xml                       | Enables reading SCXML (xml) files.                                                                              | quick-xml, ureq, url | +&#160;~&#160;??&#160;MiB           |
...
| BasicHttpEventIOProcessor | Adds an implementation of BasicHttpEventIOProcessor                                                             | rocket, ureq         | _- not finished -_                  |
...
The rfsm files must be converted offline from SCXML by `scxml_to_fsm`.<br/>
